    ...
    <div className="container mx-auto mt-10">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div>
          ...
          <TextareaAutosize 
          id="content" name="content" className="w-full border p-2"
           placeholder="Markdown形式で入力してください" minRows={8} 
           value={content} onChange={handleContentChange}></TextareaAutosize>
        ...
        {preview && (
          <div className="border p-4 bg-gray-400 prose">
            <ReactMarkdown
